...
{
    if (strstr($_SERVER['SERVER_NAME'], 'sample-page.local')) {
        wp_enqueue_script('main-js', 'http://localhost:3000/bundle.js', null, null, true);
    } else {
        wp_enqueue_script('vendors-js', get_theme_file_uri('/dist/index.645b5e7423e848a13a09.js'), null, '1.0', true);
        wp_enqueue_script('main-js', get_theme_file_uri('/dist/vendors.87d3bc95e69216a123c9.js'), null, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/dist/styles.645b5e7423e848a13a09.css'));
    }
}
